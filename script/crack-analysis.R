...
#Personas encuestadas por edades cuantas_veces, uso_1, uso_2, last_12, last_30
ggplot(as.data.frame(sex)) +
  theme_bw()+
...
#cuantos años tenía
sort(unique(data1$di4c))
data1$di4c <- as.numeric(data1$di4c)

data1$entidad <- NULL
data1$munici <- NULL


summary(as.factor(data1$ddg1a))
summary(as.factor(data1$ddg2a))
summary(as.factor(data1$ddg2a1))
summary(as.factor(data1$ddg3a))
summary(as.factor(data1$ddg4a))
summary(as.factor(data1$ddg5a))
summary(as.factor(data1$ddg6a))
summary(as.factor(data1$ddg7a))
summary(as.factor(data1$ddg8a))
summary(as.factor(data1$ddg9a))
summary(as.factor(data1$ddg10a))
summary(as.factor(data1$ddg11a))
summary(as.factor(data1$ddg12a))
summary(as.factor(data1$ddg13a))
summary(as.factor(data1$ddg14a))
summary(as.factor(data1$ddg15a))
summary(data1)
...
data1.resc <- apply(data1.resc, 2, rescale)
set.seed(1)
